...
public class UserAdminPanel extends JPanel implements IObserver {
  ...
  private void updateLanguage() {
    this.lblFirstName.setText(LANGUAGES.getLabelWithColon("firstName"));
    this.lblLastName.setText(LANGUAGES.getLabelWithColon("lastName"));
    ...
    this.lblPasswordVerify.setText(LANGUAGES.getLabelWithColon("passwordVerify"));
    this.lblUserGroup.setText(LANGUAGES.getLabelWithColon("userGroup"));
    this.lblActiveState.setText(LANGUAGES.getLabelWithColon("activeState"));
    this.lblClientDataSet.setText(LANGUAGES.getLabelWithColon("clientDataSet"));
    this.lblCreateDate.setText(LANGUAGES.getLabelWithColon("createDate"));
    this.lblUpdateDate.setText(LANGUAGES.getLabelWithColon("updateDate"));
    this.btUpdateItems.setText(LANGUAGES.getLabel("updateItems"));
  }
