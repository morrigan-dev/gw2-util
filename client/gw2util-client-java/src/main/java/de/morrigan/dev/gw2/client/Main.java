...
public class Main implements IObserver {
  ...
  /** Hauptmodel, welches alle anderen Models bereitstellt */
  ...
  private void createCompactFrame() {
    try {
      ...
      CompactPanel compactCard = new CompactPanel(this.mainFrame, this.mainModel);
  ...
  private void createMainFrame() {
    try {
      ...
      this.mainFrame.add(new MainPanel(this.mainFrame, this.mainModel), BorderLayout.CENTER);
  ...
  private void createToolbarFrame() {
    try {
      ...
      this.toolbarFrame.add(new ToolbarCard(this.mainFrame, this.mainModel), BorderLayout.CENTER);
