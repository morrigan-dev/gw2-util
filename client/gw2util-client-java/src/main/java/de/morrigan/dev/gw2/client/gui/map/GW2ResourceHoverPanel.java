...
public class GW2ResourceHoverPanel extends GW2HoverPanel {
	...
	public void configureGUI() {
		...
		this.lblInfo.setFont(Main.getInstance().getMenomonia().deriveFont(14f).deriveFont(Font.BOLD));
		this.lblGatheringInfo.setFont(Main.getInstance().getMenomoniaItalic().deriveFont(14f));
		this.lblCreateInfo.setFont(Main.getInstance().getMenomoniaItalic().deriveFont(14f));
	...
	public void setData(String info, List<ImageIcon> resIcons, List<String> resInfos, ImageIcon gatheringIcon,
		...
		for (int i = 0; i < resIcons.size(); i++) {
			...
			resInfo.setFont(Main.getInstance().getMenomoniaItalic().deriveFont(14f));
