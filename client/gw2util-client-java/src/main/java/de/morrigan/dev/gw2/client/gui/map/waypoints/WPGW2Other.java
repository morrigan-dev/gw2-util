...
public class WPGW2Other extends AbstractGW2Waypoint {
  ...
  public WPGW2Other(long id, GeoPosition position, WPType wpType, WPSubType wpSubType, Date updateDate,
      String username) {
    super(position, LANGUAGES.getLabel(wpSubType.getLabelKey()), wpType, wpSubType);
    this.id = id;
  ...
  protected ZoomScale[] getZoomScale() {
    ...
    switch (getWPSubType()) {
      case GUILD_BOUNTY:
        result = new ZoomScale[] {
            new ZoomScale(0, 1), new ZoomScale(1, 1.5), new ZoomScale(2, 2),
            new ZoomScale(3, 2.5)
        };
      break;
      ...
      case CHEST:
        result = new ZoomScale[] {
            new ZoomScale(0, 1), new ZoomScale(1, 1.5), new ZoomScale(2, 2.5),
            new ZoomScale(3, 3)
        };
      break;
    }
