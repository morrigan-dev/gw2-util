package de.morrigan.dev.gw2.client.model.table;
 ...
 * @author morrigan
 */
public abstract class AbstractGW2TableModel<T> extends AbstractTableModel implements IGW2TableModel<T> {

  private static final long serialVersionUID = 1L;

  /** Logger für Debugausgaben */
  private static final Logger LOG = LoggerFactory.getLogger(AbstractGW2TableModel.class);
  ...
  public AbstractGW2TableModel(final List<T> dataList, final int columnCount) {
    super();
  ...
  public String getColumnName(final int columnIndex) {
    ...
    return LANGUAGES.getLabel(this.columnNames[columnIndex]);
  }
