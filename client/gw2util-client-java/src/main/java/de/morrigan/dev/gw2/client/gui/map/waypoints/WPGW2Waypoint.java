...
public class WPGW2Waypoint extends AbstractGW2Waypoint {

	public WPGW2Waypoint(GeoPosition position, String hoverInfo) {
		super(position, hoverInfo, WPType.WAYPOINT, null);
	}
