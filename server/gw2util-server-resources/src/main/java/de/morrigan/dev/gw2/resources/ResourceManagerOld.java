...
public final class ResourceManagerOld extends AObservable {

  /** Local für Schweden */
  public static final Locale SWEDISH = new Locale("sv");

  /** Logger für Debugausgaben */
  private static final Logger LOG = LoggerFactory.getLogger(ResourceManagerOld.class);

  /** Einzige Instanz des ResourceManagers (Singleton) */
  private static final ResourceManagerOld MANAGER = new ResourceManagerOld();
   ...
   */
  public static ResourceManagerOld getInstance() {
    return MANAGER;
  }
   ...
   */
  protected void syncViews(final long updateFlag) {
    setChanged();
