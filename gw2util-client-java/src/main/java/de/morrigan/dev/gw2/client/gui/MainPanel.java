...
public class MainPanel extends JPanel implements IObserver, INavigation, IThreadCallback {
	...
	@RightCheck(rightKeys = { "administrate" }, type = Type.FIELD)
	...
	public void basicDataAvailable() {
		this.gw2APIModel.loadWaypointsFromAPI(this.dynamicMapCard.getMapViewer());
	...
	public void waypointsAvailable() {
		GW2MapModel.getInstance().setStaticWaypoints(this.gw2APIModel.getGw2Waypoints(), this.gw2APIModel.getGw2POIs(),
				this.gw2APIModel.getGw2Unlock(), this.gw2APIModel.getGw2Vista(), this.gw2APIModel.getGw2Skill(),
				this.gw2APIModel.getGw2Heart(), this.gw2APIModel.getGw2MapInfo());
	}
