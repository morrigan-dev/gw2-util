...
public class AdminModel extends AbstractModel {
	...
	public static final long ACTIVE_STATE_CHANGED = BitUtils.setLongBit(2);
	public static final long FIRST_NAME_CHANGED = BitUtils.setLongBit(3);
	public static final long LAST_NAME_CHANGED = BitUtils.setLongBit(4);
	public static final long USER_NAME_CHANGED = BitUtils.setLongBit(5);
