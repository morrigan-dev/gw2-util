...
public class GW2MapModel extends AbstractModel {
	...
	public static final long MAP_ACTION_MODE_CHANGED = BitUtils.setLongBit(0);

	public static final long WAYPOINTS_CHANGED = BitUtils.setLongBit(1);
	public static final long FILTER_CHANGED = BitUtils.setLongBit(2);

	public static final long ORE_ORICHALCUM = BitUtils.setLongBit(30);
	public static final long ORE_MITHRIL = BitUtils.setLongBit(31);
	public static final long ORE_PLATINUM = BitUtils.setLongBit(32);
	public static final long ORE_GOLD = BitUtils.setLongBit(33);
	public static final long ORE_SILVER = BitUtils.setLongBit(34);
	public static final long ORE_IRON = BitUtils.setLongBit(35);
	public static final long ORE_COPPER = BitUtils.setLongBit(36);
	public static final long WOOD_ANCIENT = BitUtils.setLongBit(40);

	public static final long WOOD_ELDER = BitUtils.setLongBit(41);
	public static final long WOOD_HARD = BitUtils.setLongBit(42);
	public static final long WOOD_SEASONED = BitUtils.setLongBit(43);
	public static final long WOOD_SOFT = BitUtils.setLongBit(44);
	public static final long WOOD_GREEN = BitUtils.setLongBit(45);
	public static final long PLANT_ORICHALCUM_STICKLE = BitUtils.setLongBit(50);

	public static final long PLANT_MITHRIL_STICKLE = BitUtils.setLongBit(51);
	public static final long PLANT_DARKSTEEL_STICKLE = BitUtils.setLongBit(52);
	public static final long PLANT_STEEL_STICKLE = BitUtils.setLongBit(53);
	public static final long PLANT_IRON_STICKLE = BitUtils.setLongBit(54);
	public static final long PLANT_COPPER_STICKLE = BitUtils.setLongBit(55);
